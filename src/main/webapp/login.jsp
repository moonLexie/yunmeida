                ...
                <div class="row">
                    ...
                    <div class="col-lg-6 p-t-100">
                        <div class="text-white">
                            <h1>欢迎回来</h1>
                            <p class="s-16 p-t-b-20 font-weight-lighter">这里是运美达企业网站管理后台系统
                                <br/><span class="s-14 font-weight-lighter">This is yunmeida enterprise website management background system</span></p>
                        </div>
                        <form action="/managerUser/login" method="post">
                            <div class="row">
                                ...
                                <div class="col-lg-12">
                                    <input type="submit" class="btn btn-success btn-lg btn-block" value="登 陆">
